...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  flex justify-center"><!-- <BlogSideBar headings={headings} />
    <BlogContent content={content}> -->${articulo ? renderTemplate`${renderComponent($$result2, "Fragment", Fragment, {}, { "default": ($$result3) => renderTemplate`<h1>${articulo.titulo}</h1><p class="poppins flex text-justify">${articulo.contenido}</p><h1 class="text-right"><a href="/derechoshumanos/">${articulo.categoria}</a></h1>` })}` : renderTemplate`<p>Loading...</p>`}<!-- <slot /> --><!-- </BlogContent> --></main>` })}`;
}, "C:/Users/cesar/Downloads/Diccionario-Filos-fico-main (PRODUCCION)/Diccionario-Filos-fico-main/src/pages/derechoshumanos/[id].astro", void 0);

const $$file = "C:/Users/cesar/Downloads/Diccionario-Filos-fico-main (PRODUCCION)/Diccionario-Filos-fico-main/src/pages/derechoshumanos/[id].astro";
const $$url = "/derechoshumanos/[id]";
